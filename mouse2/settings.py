"""
Django settings for mouse2 project on Heroku. Fore more info, see:
...
SUIT_CONFIG = {
    ...
    'MENU': (
        ...
        {'label': 'Mouse List', 'icon': None, 'url': '/admin/runner/mouse'},
        {'label': 'Box List', 'icon': None, 'url': '/admin/runner/box'},
        {'label': 'Video Sessions', 'icon': None, 'url': '/admin/whisk_video/videosession'},
        {'label': 'Grand Sessions', 'icon': None, 'url': '/admin/runner/grandsession'},
...
WSGI_APPLICATION = 'mouse2.wsgi.application'
